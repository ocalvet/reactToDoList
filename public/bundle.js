...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2['default'].render(_react2['default'].createElement(_TodoList2['default'], null), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoForm = __webpack_require__(159);

	var _TodoForm2 = _interopRequireDefault(_TodoForm);

	var _TodoItem = __webpack_require__(160);
		...
		_createClass(TodoList, [{
			...
			value: function render() {
				...
				var listItems = this.state.data.map(function (listItem) {
					return _react2['default'].createElement(_TodoItem2['default'], { item: listItem, removeMe: todoList._removeItem });
				});

				return _react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement(_TodoForm2['default'], { addItem: this._addItem }),
					listItems
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoForm = (function (_React$Component) {
		...
		function TodoForm(props) {
			...
			_get(Object.getPrototypeOf(TodoForm.prototype), "constructor", this).call(this, props);
			this._addItem = this._addItem.bind(this);
		...
		_createClass(TodoForm, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					"div",
					null,
					_react2["default"].createElement("input", { type: "text", placeholder: "Enter Todo Item", ref: "todoItemInput", onKeyUp: this._keyUp }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = (function (_React$Component) {
		...
		_createClass(TodoItem, [{
			key: "_removeItemFromParent",
			value: function _removeItemFromParent() {
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						"button",
						{ onClick: this._removeItemFromParent },
						"X"
					)
				);
			}
